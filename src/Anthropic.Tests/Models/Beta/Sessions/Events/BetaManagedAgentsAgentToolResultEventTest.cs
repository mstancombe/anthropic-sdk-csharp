...
public class BetaManagedAgentsAgentToolResultEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, BetaManagedAgentsAgentToolResultEventType> expectedType =
            BetaManagedAgentsAgentToolResultEventType.AgentToolResult;
        List<BetaManagedAgentsAgentToolResultEventContent> expectedContent =
        [
            new BetaManagedAgentsTextBlock()
            {
                Text = "Where is my order #1234?",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BetaManagedAgentsAgentToolResultEvent>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaManagedAgentsAgentToolResultEvent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class BetaManagedAgentsAgentToolResultEventTypeTest : TestBase
{
    [Theory]
    [InlineData(BetaManagedAgentsAgentToolResultEventType.AgentToolResult)]
    public void Validation_Works(BetaManagedAgentsAgentToolResultEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaManagedAgentsAgentToolResultEventType> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(BetaManagedAgentsAgentToolResultEventType.AgentToolResult)]
    public void SerializationRoundtrip_Works(BetaManagedAgentsAgentToolResultEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaManagedAgentsAgentToolResultEventType> value = rawValue;
...
public class BetaManagedAgentsAgentToolResultEventContentTest : TestBase
{
    [Fact]
    ...
    {
        BetaManagedAgentsAgentToolResultEventContent value = new BetaManagedAgentsImageBlock()
        {
    ...
    {
        BetaManagedAgentsAgentToolResultEventContent value = new BetaManagedAgentsDocumentBlock()
        {
